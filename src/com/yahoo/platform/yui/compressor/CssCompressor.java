...
public class CssCompressor {
	...
	public void compress(Writer out, int linebreakpos) throws IOException {
		String css = this.getCompressedCss(linebreakpos);
		// Write the output...
		out.write(css);
	}

	/**
	 * 得到被压缩的Css,从原compress方法中提取出方法，以便HtmlCompressor类用到
	 * @author jason.zhou
	 * @param linebreakpos
	 * @return
	 * @throws IOException
	 */
	public String getCompressedCss(int linebreakpos) throws IOException {
